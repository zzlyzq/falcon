#!/bin/env python
#-*- coding:utf-8 -*-
# filname: falcon-plugins/redis-monitor.py
...
class RedisStats:
    ...
    _redis_cli = '/opt/machtalk/redis/src/redis-cli'
...
def main():
    ...
    insts_list = [ i for i in commands.getoutput("find  /opt/machtalk/redis/ -name '6379.conf'" ).split('\n') ]
    print insts_list
